...
\begin{frame}{git book}
  \begin{columns}
    ...
    \column{0.5\textwidth}
      Available as free ebook \tiny{\url{https://github.com/progit/progit2/releases/download/2.1.84/progit.pdf}}
  \end{columns}
\end{frame}
...
\section{About version control} % Section title slide, unnumbered
