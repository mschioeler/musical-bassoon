...
\subtitle{\texttt{-{}-distributed-is-the-new-centralized}}

\author{Morten Schiøler}

\titlegraphic{\includegraphics[width=0.4\paperwidth]{Images/git-logo.png}} % Optional title page image, comment this line to remove it
