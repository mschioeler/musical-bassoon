...
\texttt{-{}-distributed-is-the-new-centralized}} % Optional title page image, comment this line to remove it
...
\begin{frame}{Deltas}
  \fullbleed{deltas.png}
\end{frame}

\begin{frame}{Snapshots}
  \fullbleed{snapshots.png}
\end{frame}

\begin{frame}{The Git object model}
  \fullbleed{commit-and-tree.png}
\end{frame}
